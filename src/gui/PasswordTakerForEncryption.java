...
public class PasswordTakerForEncryption extends javax.swing.JFrame
{
    ...
    boolean verifyPasswords()
    {
        ...
        {
            eightCharInstructionLabel.setText("Enter password of atleast 8 characters");
        ...
        if(password1.length>7)
        {
            ...
            if(password1.length==password2.length)
            {
                ...
                {
                    eightCharInstructionLabel.setText("Both the passwords same!");
                    return true;
                }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(10, 36, 100, 14);
        ...
        passwordField1.setBounds(10, 60, 620, 20);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Re-enter the password:");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 87, 133, 14);
        ...
        passwordField2.setBounds(10, 107, 620, 20);
        ...
        proceedButton.setBounds(280, 140, 79, 28);
        ...
        suggestionLabel.setText("USE LONGER  AND STRONGER PASSWORD");
        getContentPane().add(suggestionLabel);
        suggestionLabel.setBounds(10, 11, 654, 19);

        eightCharInstructionLabel.setForeground(new java.awt.Color(255, 255, 51));
        eightCharInstructionLabel.setText("password must be atleast 8 characters");
        eightCharInstructionLabel.setFocusable(false);
        getContentPane().add(eightCharInstructionLabel);
        eightCharInstructionLabel.setBounds(10, 133, 250, 14);

        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\Dell\\Desktop\\syy.jpg")); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(0, 0, 650, 170);
