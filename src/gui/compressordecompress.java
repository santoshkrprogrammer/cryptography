...
public class compressordecompress extends javax.swing.JFrame
{
    private String compressordecompress;
    ...
    public compressordecompress(String compressordecompress)
    {
        this.compressordecompress=compressordecompress;
        ...
        {
            java.util.logging.Logger.getLogger(compressordecompress.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        addWindowListener( new WindowAdapter()
        {
            public void windowClosing(WindowEvent e)
            {
                ...
                else if(compressordecompress.equals("compress"))
                {
                    Toolkit.getDefaultToolkit().beep();
                    result = JOptionPane.showConfirmDialog(frame, "compress is in progress. "+"Are you sure you want to exit the application?", "Exit Application", JOptionPane.YES_NO_OPTION);
                    if (result == JOptionPane.YES_OPTION)
                      
                    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                }
                
                else if (compressordecompress.equals("decompress"))
                {
                    Toolkit.getDefaultToolkit().beep();
                     result = JOptionPane.showConfirmDialog(frame, "Decompression is in progress. "+"Are you sure you want to exit the application?", "Exit Application", JOptionPane.YES_NO_OPTION);
                     if (result == JOptionPane.YES_OPTION)
                     frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                }
        ...
        if(compressordecompress.equalsIgnoreCase("compress"))
        {
            heading.setText("compressing:");
        }
        else if(compressordecompress.equalsIgnoreCase("decompress"))
        {
            heading.setText("Decompressing:");
        }
